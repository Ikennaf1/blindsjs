const Header = () => {
    return (
        <header className="absolute top-0 w-full h-[100%] w-full bg-red-400">
            <div className="mt-24 body-margin bg-blue-400 h-[85%]">
            ...
            {/* The only dark mode package you need for your website interface */}
        </header>
    );
}
