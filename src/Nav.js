            ...
            <div className="h-16 flex items-center justify-between body-margin">                
                <a href="/" className="h-full">
                    <div className="flex items-center justify-left md:ml-0">
                        <div className="link h-full" style={{"width": "3rem", "height": "3rem", "display": "inline-block", "color": "coral", "marginTop": 16}}>
                ...
                <div className="cursor-pointer p-2 rounded-full hover:bg-gray-100/10" id="blinds_id"></div>
                <div className="text-sm">
                    <ul className="flex items-center">
                        <Link to="/docs/"><li className="uppercase hidden md:block">Documentation</li></Link>
                        <Link to="/docs/"><li className="uppercase hidden sm:block md:hidden">Docs</li></Link>
