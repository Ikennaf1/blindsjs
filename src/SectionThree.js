        ...
        <section className="mt-16">
            <div className="body-margin">
                ...
                <div className="w-full sm:w-[80%] lg:w-[60%] mx-auto">
                    ...
                    <ul className="flex mt-4 justify-around items-center text-xl font-bold">
                        <li>Light weight</li>
                        <li>·</li>
                        <li>Flexible</li>
                        <li>·</li>
                ...
                <p className="mt-4 text-lg w-full sm:w-[80%] lg:w-[70%] text-center mx-auto">Regardless of your framework, Blinds got you covered. Switch up to the plug that lets you easily customize. Blinds is robust, yet quiet.</p>
