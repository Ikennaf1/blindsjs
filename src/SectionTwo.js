...
const SectionTwo = () => {
    return (
        <section className="bg-gray-800 text-white mt-16">
            <div className="body-margin py-4">
                <div className="block w-full sm:flex sm:items-center sm:justify-between sm:gap-10">
                    <div className="sectionTwoBgImg flex-1 bg-cover bg-center bg-no-repeat text-center">
                        <div className="flex items-center justify-center bg-[#ff6644]/20 w-16 h-16 rounded-2xl mx-auto">
